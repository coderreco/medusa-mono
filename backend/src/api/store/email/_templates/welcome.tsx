...
export default function Welcome({ products }: { products: ProductDTO[] }) {
  return (
    <Layout preview="Welcome to Drift!">
      <Section className="w-full px-5 my-20" align="left">
        ...
        <EmailBody
          paragraphs={[
            "Welcome to the Drift family – your new go-to spot for the most delicious, freshly baked cookies!  We’re thrilled to have you here and can’t wait to satisfy your sweet tooth with our mouthwatering treats.",
            "What’s Baking at Drift?",
